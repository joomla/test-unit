...
use Tests\Joomla\CMS\Image\ImageInspector;
...
class ImageTest extends \TestCase
{
	...
	public function testGetFilterInstance()
	{
		...
		$filter = $image->getFilterInstance('imagefilterinspector');

		$this->assertInstanceOf('Joomla\\CMS\\Image\\Filter\\ImageFilterInspector', $filter);
	}
	...
	public function testFilter()
	{
		...
		$mockFilter = $this->getMockForAbstractClass('Joomla\\CMS\\Image\\ImageFilter', array($handle), 'JImageFilterMock', true, false, true);
